    ...
    return (
        <article className="w-[900px] mx-auto py-10 max-[1000px]:w-[700px] max-[750px]:w-[90%]">
            <div className="flex items-center mb-4">
                <Image width={40} height={40} src="/randomuser.jpg" alt="user-image" className="rounded-full w-10 h-10 mr-4"/>
            ...
            <footer className="mb-5 text-gray-500 text-sm">
                <p>Reviewed in the United Kingdom on <time>March 3, 2017</time></p>
            </footer>
            ...
            <aside>
                ...
                <div className="flex items-center mt-3">
                    <a className="cursor-pointer px-2 py-1.5 text-xs font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                        Helpful
                    </a>
                    <a className="cursor-pointer ps-4 text-sm font-medium text-blue-600 hover:underline dark:text-blue-500 border-gray-200 ms-4 border-s md:mb-0 dark:border-gray-600">
                        Report abuse
                    </a>
                </div>
            </aside>
