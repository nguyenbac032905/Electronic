...
const SimpleSlider = () => {
    ...
    return(
        <div className="slider-container max-w-screen-2xl mx-auto px-16 max-md:px-7 w-full">
            <Slider {...setting}>
                <div className="h-[500px] max-lg:h-[400px] max-md:h-[250px] max-[500px]:h-[200px] max-[400px]:h-[150px] relative">
                    <div className="absolute left-[50%] translate-x-[-50%] translate-y-[30%] h-full text-center max-lg:translate-y-[25%] max-sm:hidden">
